...
def run():
    ...
    fig, ax = grapher.create_chart(chart_type_setting, username_setting, "gist", lang_data, max_langs_setting, minimum_percentage_setting, donut_hole_width_setting, color_file_path)
